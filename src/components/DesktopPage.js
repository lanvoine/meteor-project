                        ...
                        <div className="site-layout-content">
                            <Row align="middle">
                                <Col span={4} align="middle">
                                    <DatePicker onChange={onChangeDate} disabledDate={disabledDate} style={{ color: "#ffffff", width: "100%", textAlign: 'center', margin: "10px", height: '5vh' }} />
                                </Col>
                                <Col span={4} align="middle">
                                    <TimePicker minuteStep={15} format="HH:mm" disabledHours={disabledHours} disabledMinutes={disabledMinutes} onChange={onChangeTime} style={{ color: "#ffffff", width: "100%", textAlign: 'center', margin: "10px", height: '5vh' }} />
                                </Col>
                                <Col span={16} align="middle">
                                    <Select
                                        ...
                                        style={{
                                            color: "#000000", width: "100%", textAlign: 'start', margin: "10px", height: '10%'
                                        }}
                            ...
                            <Row align="middle">
                                ...
                                <Col span={12} align="middle">
                                    <Card title="Weather" style={{ width: 300, textAlign: "start" }}>
